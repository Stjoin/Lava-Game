...
-[ReplicaService]---------------------------------------
	...
	WARNINGS FOR "Replica.Data" VALUES:
		! Do not create numeric tables with gaps - attempting to replicate such t ables will result in an error;
...
do
	...
	local GoodSignal = require(Madwork.GetShared("Madwork", "GoodSignal"))
	Madwork.NewScriptSignal = GoodSignal.NewScriptSignal
	Madwork.NewArrayScriptConnection = GoodSignal.NewArrayScriptConnection
end
...
local Maid = require(Madwork.GetShared("Madwork", "Maid"))
